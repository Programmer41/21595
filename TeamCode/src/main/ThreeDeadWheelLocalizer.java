...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 672.4824008489087; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -1594.1793742609564; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 3201.900611845107; // x position of the perpendicular encoder (in tick units)
    }
